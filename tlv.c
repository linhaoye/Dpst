...
int 
validate_tlv_len(tlv_type_t type, uint32_t length) {
  int b = 0;
  switch (type) {
  case TLV_TYPE_INT8:
  case TLV_TYPE_UINT8:
...
int 
pack_int8(uint8_t *int8, uint8_t *outbuf, uint32_t *out_sz) {
...
int 
pack_int16(uint16_t *int16, uint16_t *outbuf, uint32_t *out_sz) {
...
int 
unpack_int16(uint16_t *int16, uint16_t *outbuf, uint32_t *out_sz) {
  if (NULL == int16 || NULL == outbuf || NULL == out_sz) {
    return -1;
  }
  if (2 > *out_sz) {
...
int 
pack_int32(uint32_t *int32, uint32_t *outbuf, uint32_t *out_sz) {
...
int 
unpack_int32(uint32_t *int32, uint32_t *outbuf, uint32_t *out_sz) {
  if (NULL == int32 || NULL == outbuf || NULL == out_sz) {
    return -1;
  }
  if (4 > *out_sz) {
...
int 
pack_bytes(void *inbuf, uint32_t in_sz, void *outbuf, int32_t *out_sz) {
